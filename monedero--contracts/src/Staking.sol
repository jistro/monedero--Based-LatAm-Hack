...
contract Staking is ReentrancyGuard {
    ...
    constructor(
        ...
        mUSDCAddress.actual = address(new mUSDC(address(this), _masterWallet));
     ...
     */
    function stkingUSDC(uint256 _amount) external nonReentrant returns (bool) {
        if (
    ...
    function cancel_ProposemUSDCAddress() external onlyMasterWallet {
    ...
    function add_Unstaking24HoursAdmin(address _proposed)
        external
        onlyMasterWallet
    {
    ...
    function remove_ProposeUnstaking24HoursAdmin(address _proposed)
        external
        onlyMasterWallet
    {
    ...
    function getPendingUnstaking24Hours(address _user)
        external
        view
        returns (uint256)
    {
    ...
    function getUnstaking24HoursAdminList(address _admin)
        external
        view
        returns (bool)
    {
